...
define([
  ...
  gsvc = new GeometryService("https://gis.cityoftacoma.org/arcgis/rest/services/Utilities/Geometry/GeometryServer");  //Geometry Service - used to perform the buffer
  ...
  var mjm_ClickReportFunctions = {
    ...
    newReport: function (currentMap, mapClick, SR) {
      ...
      if (map.infoWindow.domNode.className != "esriPopupMobile") {  //Determine if desktop or mobile popup being used
        ...
        on(dnd, 'FirstMove', function () {  //When infoWindow moved, hide pointer arrow:
